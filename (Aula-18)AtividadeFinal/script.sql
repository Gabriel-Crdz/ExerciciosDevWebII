...
/* Insert's */
INSERT INTO padawan (nome, especie, idade, estado, id_mestre, id_planeta, cor_sabre)
VALUES
('Ezra Bridger', 'Humano', 17, 'A', 5, 6, 'azul'),
('Gungi', 'Wookiee', 14, 'A', 9, 24, 'verde'),
('Reva Sevander', 'Humana', 12, 'A', 17, 21, 'azul'),
('Trilla Suduri', 'Humana', 15, 'A', 6, 1, 'verde'),
('Zatt', 'Nautolano', 13, 'A', 10, 55, 'amarelo');
