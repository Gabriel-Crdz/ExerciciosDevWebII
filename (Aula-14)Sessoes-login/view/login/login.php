...
if(isset($_POST['login'])) {
    ...
    $erros = $usuCont->logar($login, $senha); // Chama o UsuarioController para realizar o login
    
    if($erros) $msgErro = implode("<br>", $erros); //Se tiver erros, mantém na mesma página e exibe-os
    else header("location: " . URL_BASE); // Se não redireciona para o index.php
}
