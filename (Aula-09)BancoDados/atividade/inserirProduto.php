...
if(isset($_GET["descricao"])){
    ...
    $erros = array();
    if($descricao == "") array_push($erros, "Informe a descrição do produto!");
    if($uni == "") array_push($erros, "Informe a unidade do produto!");
...
<body>
    ...
    <?php if (!empty($msgErros)): ?>
            ...
            <div id="divErros"><?= $msgErros ?></div>
    <?php endif; ?>
    <form method="GET">
        <input type="text" name="descricao" value="<?= $descricao ?>" placeholder="Descrição">
        <br><br>
        <input type="text" name="un_medida" value="<?= $uni ?>" placeholder="Unidade Medida">
        <br><br>
        <input id="enviar" type="submit" value="Enviar" />
    </form>
    <a id="cadastro" href="listarProduto.php">Listar Produtos</a>
</body>
</html>